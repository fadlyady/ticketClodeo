...
WebUI.click(findTestObject('issue_page/tracker/feature_tracker'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('issue_page/assigne/reza'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('issue_page/targetversion/oneID'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('issue_page/estimated_time'), estimated, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('issue_page/storypoints/sp3'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('issue_page/create_btn'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('issue_page/wrapper_tracker'), 3)

not_run: WebUI.verifyElementPresent(findTestObject('issue_page/flash_notice'), 3)
