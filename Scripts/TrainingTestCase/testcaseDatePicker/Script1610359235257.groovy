...
WebUI.callTestCase(findTestCase('login_testcase/login'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('home_page/search_field'), '4537', FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.setText(findTestObject('issue_page/subject_issue'), subject, FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.setText(findTestObject('issue_page/description_issue'), description, FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.setText(findTestObject('issue_page/estimated_time'), estimated, FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.verifyElementPresent(findTestObject('issue_page/wrapper_tracker'), 3)

WebUI.selectOptionByLabel(findTestObject('trainingObject/field_tracker'), 'feature', false)
